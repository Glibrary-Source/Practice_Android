...
import com.twproject.practice_camerax.utils.PermissionManager
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(
            ...
            PermissionManager.verifyRecordAudioPermissions(this)
            ) {
            startCamera()
        } else {
            requestMultiPermissionLauncher.launch(multiPermissionList)
        }
    ...
    companion object {
        ...
        private val multiPermissionList = mutableListOf (
